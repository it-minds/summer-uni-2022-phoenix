defmodule SummerUniWeb.UserSettingsController do
  ...
  def update(conn, %{"action" => "update_email"} = params) do
    ...
    case Accouts.apply_user_email(user, password, user_params) do
      {:ok, applied_user} ->
        Accouts.deliver_update_email_instructions(
          applied_user,
          user.email,
  ...
  def confirm_email(conn, %{"token" => token}) do
    case Accouts.update_user_email(conn.assigns.current_user, token) do
      :ok ->
        conn
