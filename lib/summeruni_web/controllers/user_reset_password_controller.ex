defmodule SummerUniWeb.UserResetPasswordController do
  ...
  def edit(conn, _params) do
    render(conn, "edit.html", changeset: Accouts.change_user_password(conn.assigns.user))
  end

  # Do not log in the user after reset password to avoid a
  # leaked token giving the user access to the account.
  def update(conn, %{"user" => user_params}) do
    case Accouts.reset_user_password(conn.assigns.user, user_params) do
      {:ok, _} ->
        conn
