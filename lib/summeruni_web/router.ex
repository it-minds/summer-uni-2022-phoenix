defmodule SummerUniWeb.Router do
  use SummerUniWeb, :router

  import SummerUniWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {SummerUniWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: SummerUniWeb.Telemetry
    end
  end
